  ...
  return (
    <>
      <div>
        ...
        {/* Language selection */}
            <div>
              <select name="language" id="lang" className="bg-white text-[18px] font-secondary xl:ml-12 cursor-pointer">
                <option value="en" selected data-i18n="english"
                  className="text-[18px] text-primary font-secondary hover:text-primary-hover">English</option>
              
                <option value="ar" data-i18n="arabic" className="text-[18px] text-primary font-secondary hover:text-primary-hover">Arabic
                </option>
              </select>
            </div>
