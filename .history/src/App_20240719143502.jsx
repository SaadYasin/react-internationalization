...
function App() {
  ...
  return (
    <>
      <div className="container flex justify-between mx-auto p-4 bg-green-800">
        ...
        <div>
          <select
            ...
            className="bg-orange-600 text-[18px] text-white font-secondary px-4 py-2 rounded-lg hover:bg-primary-hover xl:mx-12 cursor-pointer"
          >
            <option
              value="en"
              className="text-[18px] text-primary font-secondary bg-yellow-400 hover:text-primary-hover"
            >
              English
            </option>
